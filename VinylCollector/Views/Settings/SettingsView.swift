            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 28) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        APIKeyStep(number: 5, text: "Give your key a name — anything works, like *VinylCollector*.")
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 28) {
                    VStack(alignment: .leading, spacing: 8) {
                        Text("Discogs is the database VinylCollector uses to look up record details. A free account gives you a personal token that unlocks higher search limits.")
                            .font(.subheadline)
                            .foregroundStyle(.secondary)
                    }
