    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                Text("VinylCollector is a one-person project built out of a love of records. If it brings you joy, a tip goes a long way — thank you!")
                    .font(.subheadline)
        ...
        .alert("Thank you!", isPresented: $showThankYou) {
            ...
            Text("Your support means the world. Happy listening!")
        }
